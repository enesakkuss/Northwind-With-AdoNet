...
namespace TheNorthwind.DataAccess
{
    internal static class DataReaderHelper
    {
        ...
        // Bu sebepte doalyı DataReaderHelper'ın instance alınabilir bir sınıf olmasına gerek yok
        ...
        // static=> Yazılım yaşam süresi boyunca yalnızca bir instance'ının oluşacağı tipler
        ...
        public static DateTime? GetDateTimeNullable(this SqlDataReader dataReader, string fieldName) 
        {
            return dataReader.IsDBNull(fieldName)
                ? null
                : dataReader.GetDateTime(fieldName);
        }
    }
}
